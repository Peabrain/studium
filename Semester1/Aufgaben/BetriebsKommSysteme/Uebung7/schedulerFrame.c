...
LINK hrrn(LINK head,LINK current,int tStep);
LINK fcfs(LINK head,LINK current,int tStep);
LINK srt(LINK head,LINK current,int tStep);
...
/*Implementierung des Highest Response Ratio Next Algorithmus
...
{       
	...
	/*TODO: Implementieren Sie den Highest Response Ratio Next Algorithmus
...
/*Implementierung des Shortest Remaining Time
head:Kopfelement der Liste der Prozesse
current:aktuelles Element
tStep:aktueller Zeitschritt
*/
LINK srt(LINK head,LINK current,int tStep)
{
	...
	/*TODO: Implementieren Sie die Shortest Remaining Time Algorithmus
		Schreiben Sie eine geeignete Hilfsfunktion 
